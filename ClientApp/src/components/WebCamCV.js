...
function NavBar(props) {
    ...
    return (<Navbar color="dark" dark fixed expand="md" className="mb-4">
        <Container>
        ...
        <div>
            <div class="row">
                {["p", "a", "s-1", "s-2", "w", "o", "r", "d"].map((letter, i) =>
                    <div class="col">
                        <img src={`./images/test/${letter}.jpg`}
                            id={i + 1}
...
export class WebCamCV extends Component {
        ...
        img.onload = function () {
            ...
            if (objects) {
                objects.forEach(object => {
                    ...
                    ctx.fillStyle = "rgba(255,255,255," + String(object.probability) + ")";;
                    const textWidth = ctx.measureText(object.tagName + " (" + object.probability + ")").width;
                    const textHeight = parseInt(font, 10); // base 10
                    ctx.fillRect(rectangle.x, rectangle.y - (textHeight + 4), textWidth + 4, textHeight + 4);

                    ctx.fillStyle = "rgb(0,0,0)";
                    ctx.fillText(object.tagName + " (" + object.probability + ")", rectangle.x, (rectangle.y - textHeight - 2));
    ...
    capture = function () {
        ...
        fetch('https://' + this.state.endpointRegion + '.api.cognitive.microsoft.com/customvision/v3.0/Prediction/ebb75a93-8268-4ab1-98d9-5a2e8cda38c1/detect/iterations/Iteration2/image', {
            method: 'POST',
            headers: {
        ...
        return (
            ...
            >
                ...
                <div className="container">
                    <div class="row">
                        ...
                        {["w", "o", "r", "d"].map((letter, i) => {
                            return (<div class="col-sm">
                                <img src={`./cropped/${i + 5}-${letter}-boxed.jpg`}
                                    id={i + 5}
                                    style={{ maxWidth: "100%" }}
                                    className="mb-4"
                                // onmouseover="changeImage('./1-p-tagged.jpg', '1')"
                    ...
                    <h2 className="mb-4">Using Artificial Intelligence to Intercept Private User Actions in Mixed Reality</h2>
                </div>

                <section id="problem" className="py-4" style={{ backgroundColor: "#e1e6ea"}}>
                    <Container>
                        <h2>Problem</h2>
                        <div className="float-right ml-4">
                            <img style={{ maxHeight: 200 }} alt="Hololens virtual keyboard" src="./images/virtual-keyboard.png" />
                            <p><small>HoloLens Virtual Keyboard - Microsoft</small></p>
                        </div>

                        <p>After attending the HoloLens Demo hosted by Microsoft, our team observed that the current virtual keyboard contained a potential cybersecurity risk that could be exploited! We wanted to make Microsoft aware of this potential threat and propose solutions that could be pursued in the future. By exposing this vulnerability now, we have the potential to secure the privacy of the millions of people who will benefit from using virtual/mixed reality in the future!</p>
                        <p>When typing into Hololens' Virtual Keyboard, our hack intercepts the user's input. Using this, we can parse together passwords, messages, and other sensitive information with nothing more than visual contact to the target.</p>
                    </Container>
                </section>

                <section id="project-demo" className="py-4"
                ...
                <section id="solutions" className="py-4" style={{ backgroundColor: "#e1e6ea" }}>
                    <Container>
                        <h2 className="mb-4">Solutions</h2>
                        <div class="row">
                            <div class="col-lg-4">
                                <img style={{ maxHeight: 160 }} alt="Scramble keypad" src="./images/scramble-keypad.png" />
                                <img style={{ maxHeight: 160 }} alt="Number input" src="./images/number-input.png" />
                                <h3>Digital Scramble Keypad</h3>
                            </div>
                            <div class="col-lg-4">
                                <img style={{ maxHeight: 160 }} alt="two-factor authentication" src="./images/two-factor-auth.png" />
                                <h3>Two-factor Authentication</h3>
                            </div>
                            <div class="col-lg-4">
                                <img style={{ maxHeight: 160 }} alt="Iris scan authentication" src="./images/iris.jpg" />
                ...
                <Button color="secondary" size="sm" style={{ float: 'right', width: '100px'}} onClick={() => this.onSetSidebarOpen(true)}>
                    Settings
                </Button>

                <div id="live-demo" style={{ display: 'inline-block', marginLeft: '10%' }}>
                    <h3>In-browser webcam computer vision with Microsoft Azure Cognitive Services Custom Vision and React</h3>
                <br />
                ...
                <table>
                    <tbody>
                        ...
                        <tr style={{ verticalAlign: 'top' }}>
                                ...
                                <td>
                                    {this.state.caption ? <div> <h3>Currently Pressed Letter: <strong>{this.state.caption}</strong></h3> <p> ({this.state.captionConfidence}) </p> </div> : null}
                                {this.state.tags ?
                                    <div> <h3> Tags </h3> <ul>
